package com.agendacontactos.controlador;

import com.agendacontactos.modelo.Contacto;
import com.agendacontactos.repositorio.ContactoRepositorio;
...
public class ContactoControlador {
    ...
    public String guardarContacto(@Validated Contacto contacto,BindingResult bindingResult,RedirectAttributes redirect,Model modelo) {
        //antes de guardar le voy preguntar, si tiene algun error
        if(bindingResult.hasErrors()) { // BindingResult me va contener todos los errores
            // con este if le voy decir si tiene errores voy eliminar los errores
            // y voy crear un nuevo formulario para q vuelva ingresar
